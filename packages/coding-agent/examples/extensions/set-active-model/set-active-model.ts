/**
 * set_active_model extension
 *
 * Registers a `set_active_model` tool the LLM can call when the user explicitly
 * asks to change the active model in natural language ("change the model to
 * gemini-2.5-pro [google-vertex]", "cambia el modelo a claude-sonnet-4-5").
