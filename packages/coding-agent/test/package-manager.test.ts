...
Content`,
		...
		it("should resolve project paths relative to config dir", async () => {
			const extDir = join(tempDir, CONFIG_DIR_NAME, "agent", "extensions");
			mkdirSync(extDir, { recursive: true });
	...
	describe("settings source normalization", () => {
		...
		it("should store project local packages relative to config dir settings base", () => {
