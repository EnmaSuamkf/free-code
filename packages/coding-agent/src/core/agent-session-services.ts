...
export async function createAgentSessionServices(
	...
	const bundledBrowserExtensionPath = join(getDefaultExtensionsDir(), "browser");
	const resourceLoader = new DefaultResourceLoader({
		...(options.resourceLoaderOptions ?? {}),
		additionalExtensionPaths: [
			bundledBrowserExtensionPath,
			...((options.resourceLoaderOptions?.additionalExtensionPaths ?? []) as string[]),
		],
		cwd,
		agentDir,
		settingsManager,
