...
const noOpUIContext: ExtensionUIContext = {
	...
	placeCaretFromTerminalCell: () => false,
...
export class ExtensionRunner {
	...
	private _resourceDisplayFilter: ResourceDisplayFilter | undefined;
	...
	bindCore(
		...
		this.runtime.getActiveBuiltinToolNames = actions.getActiveBuiltinToolNames;
		this.runtime.getLoadedSkillPaths = actions.getLoadedSkillPaths;
		this.runtime.getLoadedExtensionPaths = actions.getLoadedExtensionPaths;
		this.runtime.getResourceDisplayFilter = actions.getResourceDisplayFilter;
		this.runtime.setResourceDisplayFilter = actions.setResourceDisplayFilter;
