import { type Model, modelsAreEqual } from "@free/pi-ai";
import { Container, type Focusable, fuzzyFilter, getKeybindings, Input, Spacer, Text, type TUI } from "@free/pi-tui";
