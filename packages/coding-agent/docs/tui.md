...
**Source:** [`@free/pi-tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@free/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@free/pi-tui";
...
Import from `@free/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@free/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@free/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@free/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@free/pi-coding-agent";
import { Markdown } from "@free/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@free/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@free/pi-coding-agent";
import { DynamicBorder } from "@free/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@free/pi-tui";
...
```typescript
import { BorderedLoader } from "@free/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@free/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@free/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@free/pi-tui";
...
import { matchesKey, truncateToWidth } from "@free/pi-tui";
