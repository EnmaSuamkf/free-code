...
- Built-in: `dark`, `light`, plus Catppuccin Mocha, Cyberpunk, Gruvbox Dark, Nord, oh-p-dark, and Tokyo Night (same palette set as [oh-pi](https://github.com/ifiokjr/oh-pi/tree/main/packages/themes/themes))
