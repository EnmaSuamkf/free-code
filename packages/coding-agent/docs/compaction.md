...
For TypeScript definitions in your project, inspect `node_modules/@free/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@free/pi-coding-agent";
