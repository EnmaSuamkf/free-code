// Static model registry — edit manually to add/remove models.
// Previously auto-generated from external APIs (models.dev, OpenRouter, Vercel AI Gateway).
// Run 'git diff' after editing to verify your changes.
