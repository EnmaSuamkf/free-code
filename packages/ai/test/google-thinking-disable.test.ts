...
describe("Google Vertex thinking disable E2E", () => {
	...
	it.skipIf(!vertexOptions)("disables thinking for Gemini 2.5 Pro", { retry: 2, timeout: 30000 }, async () => {
		await expectThinkingDisabledE2E(getModel("google-vertex", "gemini-2.5-pro"), {
